...
public class ActivityInspectionlist2BindingImpl extends ActivityInspectionlist2Binding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.b_urgent, 4);
        sViewsWithIds.put(R.id.b_normal, 5);
        sViewsWithIds.put(R.id.b_tag, 6);
    ...
    public ActivityInspectionlist2BindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 8, sIncludes, sViewsWithIds));
    }
    private ActivityInspectionlist2BindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
