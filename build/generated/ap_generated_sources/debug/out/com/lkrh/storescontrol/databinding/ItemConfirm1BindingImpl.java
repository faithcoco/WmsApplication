...
public class ItemConfirm1BindingImpl extends ItemConfirm1Binding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.l_input, 7);
    }
    // views
    // variables
    // values
    ...
    public ItemConfirm1BindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 8, sIncludes, sViewsWithIds));
    }
    private ItemConfirm1BindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x3L) != 0) {
            ...
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.tvTitle4, dataField4text);
