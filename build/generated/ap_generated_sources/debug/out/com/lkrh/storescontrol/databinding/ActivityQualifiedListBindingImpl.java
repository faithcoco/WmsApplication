...
public class ActivityQualifiedListBindingImpl extends ActivityQualifiedListBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.iv_cwhcode, 4);
        sViewsWithIds.put(R.id.et_qualified, 5);
    }
    // views
    @NonNull
    ...
    public ActivityQualifiedListBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 6, sIncludes, sViewsWithIds));
    }
    private ActivityQualifiedListBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
